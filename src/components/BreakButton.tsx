...
export default function BreakButton({ childName }: { childName: string }) {
  ...
  return (
    <>
      <button
        onClick={flagBreak}
        className="fixed bottom-6 left-4 md:left-auto md:right-24 z-40 bg-green-100 text-green-700 px-4 py-2 rounded-full text-sm font-medium shadow-md hover:bg-green-200 transition-colors border border-green-200"
      >
        🌿 I Need a Break
      </button>
