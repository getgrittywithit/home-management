...
import { Settings, User, Phone, Printer, Upload, CheckSquare, Shield, ShieldCheck, Clock } from 'lucide-react'
...
import ReminderManager from './parent/ReminderManager'
import { getAllFamilyData } from '@/lib/familyConfig'

type SubTab = 'config' | 'accounts' | 'reminders' | 'aboutme' | 'contacts' | 'print' | 'bulk-docs' | 'todos'
...
export default function SettingsExpandedTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      {subTab === 'reminders' && <ReminderManager />}
