  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 left-4 md:bottom-6 md:left-6 z-40 bg-white border border-gray-200 shadow-lg hover:shadow-xl rounded-full pl-2 pr-3 py-2 flex items-center gap-2 transition-all hover:scale-105 active:scale-95"
      >
